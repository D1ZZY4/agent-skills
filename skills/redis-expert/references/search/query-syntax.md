...
- Reference: [Query Syntax](https://redis.io/docs/latest/develop/ai/search-and-query/query/), [Escaping](https://redis.io/docs/latest/develop/ai/search-and-query/query/#tokenization)
